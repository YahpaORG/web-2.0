...
const baseUrl = process.env.NEXT_PUBLIC_CMS_URL ? `https://${process.env.NEXT_PUBLIC_CMS_URL}` : ''

export const SlackConfirmEmail = ({ validationUrl }: SlackConfirmEmailProps) => (
  <Html>
    <Head />
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={codeBox}>
          <Text style={confirmationCodeText}>{validationUrl}</Text>
        </Section>
